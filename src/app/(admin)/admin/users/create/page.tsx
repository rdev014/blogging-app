...
export default function CreateUserPage() {
  ...
  // Initial state for the new user
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Simulate an API call to create a new user (replace this with actual API)
      setTimeout(() => {
        console.log("New User Created:", user);
        // After successful creation, redirect to users list page
  ...
  return (
    <div className="min-h-screen bg-gray-100 dark:bg-gray-900 text-gray-800 dark:text-gray-200">
      ...
      <header className="flex items-center justify-between px-6 py-4 bg-white dark:bg-gray-800 shadow-md">
        <h1 className="text-2xl font-bold text-orange-600">Create New User</h1>
      </header>
