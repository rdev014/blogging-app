...
export default function SubmissionsPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setMessage("Your submission has been successfully received.");
    } catch (error) {
      setMessage("There was an error submitting your content. Please try again.");
    } finally {
  ...
  return (
    <div className="min-h-screen bg-gray-100 dark:bg-gray-900 text-gray-800 dark:text-gray-200">
      ...
      <header className="flex items-center justify-between px-6 py-4 bg-white dark:bg-gray-800 shadow-md">
        <h1 className="text-2xl font-bold text-orange-600">Submit Your Content</h1>
      </header>

      {/* Main Content */}
      <main className="max-w-3xl mx-auto py-10 px-6">
        <h2 className="text-xl font-semibold mb-6 text-center">Submit an Article or Idea</h2>
